...
contract('SingleAssetBuyerEther', async (accounts) => {
  ...
  const describeTests = ({ isSmartPool }) => {
    describe(`isSmartPool: ${isSmartPool}`, async () => {
  ...
  async function linkDeployedContracts () {
    ...
    singleAssetBuyer = await SingleAssetBuyerEther.deployed()
  }
